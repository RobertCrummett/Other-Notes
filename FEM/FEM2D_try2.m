...
tid = pointLocation(TR,0.8,0.8);

figure(1)
hold on
patch('faces',cl(:,tid)','vertices',p','facecolor','r','edgecolor','k')
hold off

xi = linspace(0.1,0.8,1001);
yi = linspace(0.2,0.9,1001);
d = [xi; yi]' - [xi(1) yi(1)];
d = sqrt(d.^2);
vi = Interpolate2D1D(p,cl,V,[xi;yi]');
plot(d,vi)